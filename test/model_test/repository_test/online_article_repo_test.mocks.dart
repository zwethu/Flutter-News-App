...
import 'package:news_app/model/entities/article_response.dart' as _i3;
...
class MockNewsApiService extends _i1.Mock implements _i4.NewsApiService {
  ...
  @override
  _i5.Future<_i3.ArticleResponse> fetchArticle(String? topic) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchArticle,
          [topic],
        ...
        returnValue:
            _i5.Future<_i3.ArticleResponse>.value(_FakeArticleResponse_1(
          this,
          Invocation.method(
            #fetchArticle,
            [topic],
